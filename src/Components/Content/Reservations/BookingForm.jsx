    ...
    <section className="Booking-Form">
      <div className="flex justify-center pt-20">
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <div className="rounded-xl border shadow-sm p-3 w-[316px]">
            <Calendar
              mode="single"
              selected={date}
              onSelect={(newDate) => {
          ...
          <button
            className="bg-black text-white p-2 disabled:bg-gray-400"
            disabled={!reservation.reservation_time || !reservation.party_size}
          >
            Create Reservation
          </button>
        </form>
